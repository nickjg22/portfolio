      ...
      <main className="max-w-6xl w-full mx-auto p-6 grid grid-cols-1 md:grid-cols-3 gap-12 my-6 flex-grow">
        ...
        <div className="md:col-span-2 flex flex-col gap-6">
          ...
          <div className="text-base text-gray-600 dark:text-gray-300 flex flex-col gap-4 leading-relaxed">
            <p>
              Hi, I&apos;m Nick Gonzalez. I hold a bachelor&apos;s degree in **Finance**, which gave me a strong
              foundation in analytical thinking, data management, and problem-solving. However, my curiosity for
              building things led me to the world of software development.
            </p>
            <p>
              Currently, I am expanding my skills in **Computer Science**, focusing deeply on modern web technologies
              like **React, TypeScript, and Python**. I love bridging the gap between numbers and functional code,
              finding clean software solutions to complex financial and data workflows.
            </p>
            <p>
              Alongside my studies, I work as a **Student Services Representative**, where I develop communication
              skills and help manage team updates every single morning.
            </p>
          </div>

          {/* SECCIÓN CREATIVA: PASATIEMPOS */}
          <div className="mt-6">
            <h2 className="text-xl font-bold mb-4 text-gray-900 dark:text-gray-100">When I&apos;m Not Coding</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl border border-gray-100 dark:border-slate-800 bg-gray-50 dark:bg-slate-800/50">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                  Mastering the science behind wild yeast, fermentation timers, and perfect crust lines.
                </p>
              </div>
              <div className="p-4 rounded-xl border border-gray-100 dark:border-slate-800 bg-gray-50 dark:bg-slate-800/50">
                <span className="text-2xl">🥩</span>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                  Perfecting cooking techniques for high-quality cuts like brisket and picanha.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col gap-6">
          <div className="p-6 rounded-2xl border border-gray-100 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm flex flex-col gap-4">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400">
              Feel free to reach out or explore my active code repositories.
            </p>
